...
$ultimosid=ControladorFormularios::ctrUltimosId();
  ...
  $ultimoidmovproducto=$ultimosid['idUltimoMovProducto_'];

$productos=ControladorFormularios::ctrListaProductos();
...
<div class="container">
           <br>
            <h2>Ajuste Stock de Productos</h2>
            <hr> 
            <br>
          <form method="post" class="needs-validation" id="formajustestockproducto">

  <input type="hidden" name="utlimoIdCarneAjusteStock" value="<?php echo $ultimoidmovproducto[0][0]?>">
